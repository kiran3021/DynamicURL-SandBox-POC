...
import { DataURI, DataUri2 } from "./json";
  ...
  <div className="container-fluid">
    <Offcanvas show={showoff} onHide={handleClose} placement="top" bac>
      <Offcanvas.Body>
        ...
        <form >
          <div className="row justify-content-start row-cols-5 g-2 align-items-center">
            <div className="col-3">
              <div className="input-group">
            ...
            {/* <div className="col-3">
                <div className="input-group">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      handleChangeURIParams(0, e); setArr(produce((draft) => {
                        if (draft.length == 0) {
                          draft.push("","");
                        }
                        draft[1] = 1;
                      ...
                      <div className="col-2">
                        <div className="input-group">
                          ...
                          <select
                            ...
                            value={selectedURI?.[index] || ""}
                            onChange={(e) => {
                              handleChangeURIParams(index, e); setArr(produce((draft) => {
                                if (index >= draft.length) {
                                  draft.push(...Array(index - draft.length + 1).fill(""));
                                }
                                draft[index] = draft.length+1;
                              }))
                            }}
                          >
                            <option value="">Select</option>
                            {
                              resuriData[ele]?.map((item, index) => (
