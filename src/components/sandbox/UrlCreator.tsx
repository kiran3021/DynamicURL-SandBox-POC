...
function UrlCreator({ query }: UrlCreatorProps) {
  ...
  return (
    <div className="container-fluid container-fluid__sandbox">
      ...
      <Offcanvas data-testid="offcanvas-testid" show={showoff} onHide={handleClose} placement="top" >
      ...
      <div className="d-flex gap-3 justify-content-center align-items-center mb-1 header-wrap">
        ...
        <button className="Button violet text-center svg" onClick={handleShow} aria-label="open-canvas-button"
        ...
        <div className="card p-0 my-1 justify-content-center">
          <div className="card-body" > <span aria-label="url">URL:{query ? query : "NO URL GENERATED"}</span></div>
        </div>
      </div>
      {/* iframe */}
